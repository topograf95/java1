...
public class BiDirList<T> implements
    ...
    public boolean hasNext() {
        if (this.index < this.count_elem) return true;
        this.index = 0;
    ...
    public ListItem<T> next() {
        ...
        if (this.index == 0) this.currentIterator = this.head;
        ++this.index;
        this.currentIterator = this.currentIterator.getNext();
        if (this.index >= count_elem) return this.tail;
        return this.currentIterator.getPrevious();
    }
    ...
    public void remove(T item) {
        if (count_elem == 1 && this.head.getItem().equals(item)) {
            this.head = null;
            this.tail = null;
            count_elem = 0;
        } else {
